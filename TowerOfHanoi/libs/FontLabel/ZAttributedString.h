...
#if Z_BLOCKS
typedef NS_OPTIONS(NSUInteger, ZAttributedStringEnumerationOptions) {
...
- (instancetype)initWithAttributedString:(ZAttributedString *)attr NS_DESIGNATED_INITIALIZER;
- (instancetype)initWithString:(NSString *)str;
- (instancetype)initWithString:(NSString *)str attributes:(NSDictionary *)attributes NS_DESIGNATED_INITIALIZER;
